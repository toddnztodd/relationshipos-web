...
import { Archive, ShieldCheck, Trash2, Mic, Loader2 } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-lg max-w-md w-full mx-4 overflow-hidden">
        ...
        <div className="px-6 py-3 space-y-2">
          ...
          {/* Vault note input — shown when vault is selected */}
          {selected === 'vault' && (
            <div className="ml-12 space-y-2">
              ...
              <button
                disabled
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 bg-gray-50 text-xs text-gray-400 cursor-not-allowed"
              >
